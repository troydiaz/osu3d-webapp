create table
  public.inv_items (
    ...
    constraint inv_item_created_by_id_fkey foreign key (created_by_id) references profiles (id)
...
create table
  public.inv_changes (
    ...
    constraint inv_change_created_by_id_fkey foreign key (created_by_id) references profiles (id)
  ) tablespace pg_default;