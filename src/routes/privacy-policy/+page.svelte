    ...
    <div class="flex flex-col justify-center items-center gap-8 p-12 md:gap-12 w-full h-full md:max-w-screen-lg mx-auto">
      ...
      <div class="bg-base-100 p-12 rounded-xl border border-base-content/10">
        <article class="prose">
          ...
          <p>
            At OSU 3D, accessible from https://osu3d.io/, one of our main priority is the privacy of our visitors. This Privacy
            Policy document contains types of information that is collected and recorded by OSU 3D and how we use it.
          </p>
          ...
          <p>
            ...
            information that they shared and/or collect in OSU 3D. This policy is not applicable to any information collected
          ...
          <p>For a better experience, while using our Service, we may require you to provide us with certain personally identifiable information, including but not limited to name and email. The information that we request will be retained by us and used as described in this privacy policy.</p>
          ...
          <p>
            OSU 3D follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting
          ...
          <p>
            Like any other website, OSU 3D uses "cookies". These cookies are used to store information including visitors'
          ...
          <p>
            OSU 3D's Privacy Policy does not apply to other services or websites. Thus, we are advising you to consult the
            respective Privacy Policies of these third-party services or websites for more detailed information. It may include their
          ...
          <p>
            OSU 3D does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you
