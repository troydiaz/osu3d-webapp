<script lang="ts">
  ...
  function decrementTimers() {
    ...
    if (selectedMachine.status === MachineStatus.WORKING && selectedMachineTime === 0)
      selectedMachine.status = MachineStatus.IDLE;
    // Decrement time
              ...
              <div class="flex justify-center pt-6">
                <div class="stats h-24 shadow-lg bg-base-200 bg-opacity-50 w-full">
                  ...
                  <div class="stat rounded-l-none">
                    {#if machine.status === MachineStatus.WORKING}
                      ...
                      <div class="stat-value font-light tracking-wide text-base sm:text-2xl">
                        <span class="countdown">
                          ...
                          <span class="rounded-none" style:--value={Math.floor((selectedMachineTime / 60) % 60)}
                          ></span>:
                    ...
                    {:else}
                      <div class="stat-title sm:text-sm">Time Remaining</div>
                      <div class="stat-value font-light tracking-wide text-base sm:text-2xl">-</div>
                    {/if}
                  </div>
                </div>
              </div>
