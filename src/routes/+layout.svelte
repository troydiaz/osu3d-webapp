  ...
  {#if session}
    ...
    <div class="drawer lg:drawer-open">
      ...
      <div class="drawer-content overflow-x-auto">
        ...
        <!-- <div class="lg:hidden z-20 bg-base-100 navbar fixed top-0 justify-between space-x-4 shadow border-t border-base-content/10">
      ...
      <DrawerSidebar {profile} {permissions} {supabase} />
    </div>
  {:else}
    <slot />
  {/if}
