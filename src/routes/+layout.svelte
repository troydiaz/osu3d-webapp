...
<main>
  ...
  <div class="drawer lg:drawer-open">
    ...
    <div class="drawer-content min-h-screen bg-gradient-to-b from-base-100 to-slate-100 dark:from-base-200 dark:to-slate-900">
      <div class="lg:hidden w-full z-10 bg-base-100 navbar sticky top-0 flex-row justify-between space-x-4 shadow outline outline-1 outline-base-content/5">
