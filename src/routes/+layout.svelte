...
<div class="fixed top-0 bottom-0 left-0 right-0 bg-gradient-to-bl from-base-100 to-slate-100 dark:from-black dark:to-slate-900 -z-50"></div>
  ...
  {#if session}
    ...
    <div class="drawer lg:drawer-open">
      ...
      <div class="drawer-content lg:px-16 overflow-x-auto">
        ...
        <div class="lg:hidden z-20 bg-base-100 navbar fixed bottom-0 justify-between space-x-4 shadow outline outline-1 outline-base-content/10">
