...
<div class="flex flex-col gap-4">
  <div class="flex flex-row justify-start items-center">
      ...
      <div class="grow relative">
        <input class="input input-sm input-bor w-full bg-neutral" type="text" placeholder="Filter by name..." bind:value={filterText} />
  ...
  <table class="table shadow-lg bg-neutral">
      <thead>
          <tr>
              <th>Name</th>
              <th>In Stock</th>
