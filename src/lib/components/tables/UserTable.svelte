        ...
        <tbody>
          ...
          <tr class="transition {user.checked ? 'bg-success text-success-content' : ''}">
            <td class=" grid-cols-3 gap-1 w-52 hidden md:grid">
                ...
                <span class="px-1 py-1 font-mono bg-primary text-primary-content rounded-lg text-xs">INVEN.</span>
                {/if}
                ...
                <span class="px-1 py-1 font-mono bg-primary text-primary-content rounded-lg text-xs">PRINT.</span>
                {/if}
