...
<div class="absolute border border-base-content/5 border-l-0 -translate-x-0.5" use:floatingContent>
  <div class="pointer-events-none px-4 py-1 rounded-r-lg text-2xl h-[56px] transition bg-gradient-to-b font-light text-white {activeRoute ? 'from-blue-300 to-blue-400 dark:from-blue-400 dark:to-blue-500' : 'from-blue-300 to-blue-400 dark:from-blue-400 dark:to-blue-500'}" transition:fly={{ x: -15, duration: 150}}><slot name="text" /></div>
</div>
{/if}